...
from helper_functions import initialize_q_table, pRandom, pExploit, get_state, perform_action, sarsa_calculate_new_q, create_display_environment
...
experiment_2(learning_rate, discount_rate, 6000)
